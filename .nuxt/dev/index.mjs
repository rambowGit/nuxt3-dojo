globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/std-env/dist/index.mjs';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener, getQuery, createError } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/vue/server-renderer/index.mjs';
import { withoutBase, parseURL, withQuery, joinURL } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/ufo/dist/index.mjs';
import destr from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/destr/dist/index.mjs';
import { snakeCase } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/nuxt/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/nuxt/node_modules/ohash/dist/index.mjs';
import { createStorage } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/unstorage/drivers/fs.mjs';
import defu from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/node_modules/radix3/dist/index.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{},"currencyKey":"MXQKsvxbtXKLU86bnBDJN9lMulO7R0MuAMKNZgNd"};
...
const serverAssets = [{"baseName":"server","dir":"/home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _lazy_yBCvJI = () => Promise.resolve().then(function () { return ninja$1; });
const _lazy_uWbBep = () => Promise.resolve().then(function () { return _code_$1; });
const _lazy_XTqMF4 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/ninja', handler: _lazy_yBCvJI, lazy: true, middleware: false, method: undefined },
  { route: '/api/currency/:code', handler: _lazy_uWbBep, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_XTqMF4, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_XTqMF4, lazy: true, middleware: false, method: undefined }
];
...
const ninja = defineEventHandler(async (event) => {
  const { data } = await $fetch("https://api.currencyapi.com/v3/latest?apikey=MXQKsvxbtXKLU86bnBDJN9lMulO7R0MuAMKNZgNd");
  return data;
});
...
const getClientManifest = () => import('/home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/sasha/Documents/Workspace/Training/Nuxt/nuxt-dojo/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
